...
- **Demographic shift**: Hispanic students are now the largest demographic group
- **Urban-rural divide**: Rural Nevada has many districts but a tiny fraction of students
- **Charter growth**: SPCSA schools are expanding their share of enrollment
- **Stabilization**: After decades of growth, enrollment has plateaued
- **Economic need**: High FRL rates across most districts indicate widespread economic challenges
