...
# ==============================================================================
#
# Functions for caching downloaded NDE data files to avoid repeated downloads.
#
# ==============================================================================

#' Get the cache directory for nvschooldata
#'
...
get_cache_dir <- function() {
  cache_dir <- file.path(
    rappdirs::user_cache_dir("nvschooldata"),
    "data"
  )
