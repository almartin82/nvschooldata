...
Nevada charter schools added 17,000 students since 2021 while
traditional districts bled 30,000 – and the state’s kindergarten
pipeline is swinging wildly year to year.

Part of the [njschooldata](https://github.com/almartin82/njschooldata)
family of state education data packages.

**[Full documentation](https://almartin82.github.io/nvschooldata/)** –
...
### 1. Charter enrollment surged 33% while traditional districts lost 30,000 students
...
trends](https://almartin82.github.io/nvschooldata/articles/enrollment_hooks_files/figure-html/charter-chart-1.png)

Charter vs traditional enrollment trends

[(source)](https://almartin82.github.io/nvschooldata/articles/enrollment_hooks.html#charter-enrollment-surged-33-while-traditional-districts-lost-30000-students)

------------------------------------------------------------------------

### 2. Nevada lost nearly 13,000 students between 2021 and 2026
...
[(source)](https://almartin82.github.io/nvschooldata/articles/enrollment_hooks.html#nevada-lost-nearly-13000-students-between-2021-and-2026)

------------------------------------------------------------------------

### 3. Kindergarten enrollment swung wildly: up 8% in 2022, down 9% in 2024
...
[(source)](https://almartin82.github.io/nvschooldata/articles/enrollment_hooks.html#kindergarten-enrollment-swung-wildly-up-8-in-2022-down-9-in-2024)
...
|--------------------|-----------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------|
| **Enrollment**     | 2016-2026 | [`fetch_enr()`](https://almartin82.github.io/nvschooldata/reference/fetch_enr.md) / [`fetch_enr_multi()`](https://almartin82.github.io/nvschooldata/reference/fetch_enr_multi.md) | District, school. Race, gender, FRL, SpEd, LEP     |
| Assessments        | —         | —                                                                                                                                                                                 | Not yet available                                  |
| Graduation         | —         | —                                                                                                                                                                                 | Not yet available                                  |
| **Directory**      | Current   | [`fetch_directory()`](https://almartin82.github.io/nvschooldata/reference/fetch_directory.md)                                                                                     | School-level. Contact info, charter status, locale |
...
> taxonomy](https://almartin82.github.io/nvschooldata/DATA-CATEGORY-TAXONOMY.md)
...
trends](https://almartin82.github.io/nvschooldata/articles/enrollment_hooks.html)
– 15 stories - [Function
reference](https://almartin82.github.io/nvschooldata/reference/)
...
Grade-level breakdowns (PK, K, 01-12) are available at the **school
level** only. District-level records have `grade_level == "TOTAL"` only.
To get grade-level aggregates across districts, filter on `is_school`
and aggregate.
...
- **Grade levels**: K-12 plus ungraded (UG) available at school level
  for modern format years

## Deeper Dive

### 4. Charter schools crack the top 10 in Nevada
...
[(source)](https://almartin82.github.io/nvschooldata/articles/enrollment_hooks.html#charter-schools-crack-the-top-10-in-nevada)
...
[(source)](https://almartin82.github.io/nvschooldata/articles/enrollment_hooks.html#clark-county-lost-27706-students-since-2021-while-washoe-held-steady)

------------------------------------------------------------------------

### 6. Hispanic students are 46% of Nevada enrollment, down slightly from 47% in 2021

Hispanic students are the largest demographic group in Nevada public
schools at 45.9%, followed by white students at 25.9%. Hispanic share
dipped from 46.8% in 2021 to 45.9% in 2026, a modest decrease even as
Hispanic students remain the largest group.
...
[(source)](https://almartin82.github.io/nvschooldata/articles/enrollment_hooks.html#hispanic-students-are-46-of-nevada-enrollment-down-slightly-from-47-in-2021)

------------------------------------------------------------------------

### 7. Las Vegas Metro has 61.6% of all Nevada students
...
[(source)](https://almartin82.github.io/nvschooldata/articles/enrollment_hooks.html#las-vegas-metro-has-61.6-of-all-nevada-students)

------------------------------------------------------------------------

### 8. Fifteen districts report 100% FRL eligibility
...
[(source)](https://almartin82.github.io/nvschooldata/articles/enrollment_hooks.html#fifteen-districts-report-100-frl-eligibility)

------------------------------------------------------------------------

### 9. Futuro Academy has the highest EL concentration at 41%
...
EL concentrations. Futuro Academy leads at 41.1% EL students, followed
by Equipo Academy at 38.5%.
...
[(source)](https://almartin82.github.io/nvschooldata/articles/enrollment_hooks.html#futuro-academy-has-the-highest-el-concentration-at-41)
...
[(source)](https://almartin82.github.io/nvschooldata/articles/enrollment_hooks.html#clark-county-has-5x-more-el-students-than-washoe-but-similar-frl-rates)

------------------------------------------------------------------------

### 11. 12th grade has the most students; PK has the fewest

Tracking enrollment by grade reveals a classic pattern: PK is small
(13,852), enrollment jumps at K (30,490), and peaks at 12th grade
(37,730). Grade-level data is available at the school level.
...
[(source)](https://almartin82.github.io/nvschooldata/articles/enrollment_hooks.html#th-grade-has-the-most-students-pk-has-the-fewest)

------------------------------------------------------------------------

### 12. Nevada’s smallest LEAs are charter schools, not counties
...
[(source)](https://almartin82.github.io/nvschooldata/articles/enrollment_hooks.html#nevadas-smallest-leas-are-charter-schools-not-counties)

------------------------------------------------------------------------

### 13. Lyon County has the highest IEP rate among large districts at 17%
...
[(source)](https://almartin82.github.io/nvschooldata/articles/enrollment_hooks.html#lyon-county-has-the-highest-iep-rate-among-large-districts-at-17)

------------------------------------------------------------------------

### 14. Washoe County lost 1,333 students over 5 years
...
[(source)](https://almartin82.github.io/nvschooldata/articles/enrollment_hooks.html#washoe-county-lost-1333-students-over-5-years)

------------------------------------------------------------------------

### 15. Boys outnumber girls 51.3% to 48.7% statewide
...
[(source)](https://almartin82.github.io/nvschooldata/articles/enrollment_hooks.html#boys-outnumber-girls-51.3-to-48.7-statewide)
