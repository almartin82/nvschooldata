...
Nevada charter schools added 17,000 students since 2021 while traditional districts bled 30,000 -- and the state's kindergarten pipeline is swinging wildly year to year.

Part of the [njschooldata](https://github.com/almartin82/njschooldata) family of state education data packages.

**[Full documentation](https://almartin82.github.io/nvschooldata/)** -- all 15 stories with interactive charts, getting-started guide, and complete function reference.
...
|----------|-------|----------|---------|
| **Enrollment** | 2016-2026 | `fetch_enr()` / `fetch_enr_multi()` | District, school. Race, gender, FRL, SpEd, LEP |
| Assessments | — | — | Not yet available |
| Graduation | — | — | Not yet available |
| **Directory** | Current | `fetch_directory()` | School-level. Contact info, charter status, locale |
...
- [Enrollment trends](https://almartin82.github.io/nvschooldata/articles/enrollment_hooks.html) -- 15 stories
- [Function reference](https://almartin82.github.io/nvschooldata/reference/)
